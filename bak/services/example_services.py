...
def standalone_example():
    ...
    LOG_PATH = "C:/Logs"
    CSV_FILE = "C:/Logs/WORKSTATION-01_services.csv"
...
if __name__ == "__main__":
    print("ServiceManager Module - Example Usage")
    print("=" * 60)
    print()
    print("Choose an example:")
    print("1. Standalone usage (opens only ServiceManager)")
    print("2. Integrated usage (simulates main application)")
    print("3. Test service operations (command-line testing)")
    print("4. Show CSV structure information")
    print()
    ...
    if choice == "1":
        ...
        print("\nRunning service operations test...")
