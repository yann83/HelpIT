        ...
        try:
            ...
            with open(self.csv_filename, 'r', encoding='utf-8') as csvfile:
                ...
                for row in reader:
                    ...
                    service_frame.columnconfigure(3, weight=1)  # Name column expands
                    ...
                    stop_btn.grid(row=0, column=0, padx=2)
                    ...
                    run_btn.grid(row=0, column=1, padx=2)
                    ...
                    restart_btn.grid(row=0, column=2, padx=2)

                    # Create label with service name (ID: Name)
                    service_label = ttk.Label(
                        service_frame,
                        text=f"{service_id}: {service_name}",
                        font=('Arial', 9)
                    )
                    service_label.grid(row=0, column=3, sticky="w", padx=5)
                    ...
                    status_label = tk.Label(
                        ...
                        text=service_state,
                        font=('Arial', 9, 'bold'),
                        bg=self.state_colors.get(service_state, '#9E9E9E'),  # Default gray
                        fg="white",
                        width=15,
                        relief=tk.RAISED
                    )
